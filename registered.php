                    ...
                    <?php
                        if (mysqli_num_rows($Result) > 0) {
                            ...
                            while ($rows = mysqli_fetch_array($Result)) {
                                ...
                                echo "<td>
                                        <a href='editloanapp.php?id={$rows['id']}'><button class='edit-btn'>Edit</button></a>
                                        <a href='deleteloanapp.php?id={$rows['id']}' onclick=\"return confirm(' This will delete the member and ALL their savings, time deposit, fixed accounts, and transactions. Are you sure?')\">
