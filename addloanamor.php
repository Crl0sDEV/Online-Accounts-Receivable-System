...
<html>
<head>
    <title>Add Loan Amortization</title>
    <style>
        body {
...
<body>
    ...
    <form action="addloanamorrecordsaved.php" method="post">
        <h1>Add Loan Amortization</h1>

        <div class="form-row">
            <label for="loantype"><b>Loan Type Name:</b></label>
        ...
        <div class="form-row">
            <label for="loanamor"><b>Loan Amortization:</b></label>
            <input type="number" id="loanamor" name="loanamor" required>
        </div>
