...
<body>
    ...
    <script>
        ...
        <div class="formcontainer">
            <form action="edituseracc.php?id=<?php echo $id ?>" method="post">
                ...
                <div style="display: flex; justify-content: space-between;">
                    <button class="form-button cancel-button" type="button" onclick="window.location.href='useraccounts.php'">Cancel</button>
