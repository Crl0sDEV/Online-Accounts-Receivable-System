...
$sql = "SELECT fa.*, mp.fullname, mp.email 
        FROM fixed_accounts fa
        JOIN member_profiles mp ON fa.memberid = mp.memberid";
...
<body>
    ...
    <div class="sidebar"><br><br><br><br>
        ...
        <div class="dropdown-container">
            <a href="fixedacc-member.php">Accounts</a>
            <a href="fixedtrans-member.php">Transactions</a>
        </div>
        <button class="dropdown-btn">Savings</button>
        <div class="dropdown-container">
            <a href="savingsacc-member.php">Accounts</a>
            <a href="savingstrans-member.php">Transactions</a>
        </div>
        <button class="dropdown-btn">Time Deposit</button>
        <div class="dropdown-container">
            <a href="timedepositsacc-member.php">Accounts</a>
            <a href="timedepositstrans-member.php">Transactions</a>
        </div>
        <a href="memberprof-member.php">Member Profile</a>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($Result) > 0) {
                            ...
                            echo "<tr><td colspan='8'>No fixed accounts found.</td></tr>";
                        }
                        mysqli_close($conn);
                        ?>
                    </tbody>
