    ...
    <script>
        ...
        <div class="container">
            <div class="content-box">
                <div class="title">
                    <h1>Loan Interest</h1>
                    <a href="addloani.php"><button class="add-loaninterest-btn">+ Add Loan Interest</button></a>
                </div>
                    ...
                    <?php
                        if (mysqli_num_rows($Result) > 0) {
                            ...
                            while ($rows = mysqli_fetch_array($Result)) {
                                ...
                                echo "<td>
                                    <a href='viewloani.php?id={$rows['id']}'><button class='view-btn'>View</button></a>
                                    <a href='editloani.php?id={$rows['id']}'><button class='edit-btn'>Edit</button></a>
                                    <a href='deleteloani.php?id={$rows['id']}' onclick=\"return confirm('Are you sure?')\">
