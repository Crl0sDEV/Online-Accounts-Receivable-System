...
<body>
    ...
    <div class="sidebar"><br><br><br><br>
        ...
        <div class="dropdown-container">
            ...
            <a href="fixedhistoryaccountant.php">History</a>
        </div>
        ...
        <div class="dropdown-container">
            ...
            <a href="savingshistoryaccountant.php">History</a>
        </div>
        ...
        <div class="dropdown-container">
            ...
            <a href="timedepohistoryacc.php">History</a>
        </div>
    ...
    <div class="main">
        <h1>Welcome to the Accountant Portal</h1>
        <p>Manage all transactions and keep your accounts organized effortlessly.</p>
    </div>
