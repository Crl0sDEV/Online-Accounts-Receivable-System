...
$conn = openCon();
$sql = "SELECT * FROM member_profiles";
        ...
        <div class="container">
            <div class="content-box">
                <div class="title">
                    ...
                    <a href="addmembershipprofile.php"><button class="add-user-btn">+ Add New Membership Profile</button></a>
                </div>
                        ...
                        if (mysqli_num_rows($Result) > 0) {
                            ...
                            while ($rows = mysqli_fetch_array($Result)) {
                                ...
                                echo "<td>{$rows['fullname']}</td>";
                                 echo "<td>{$rows['application_type']}</td>";
                                echo "<td>{$rows['date_applied']}</td>";
                                echo "<td>{$rows['status']}</td>";
                                echo "<td>
                                        <a href='viewmemprof.php?memberid={$rows['memberid']}'><button class='view-btn'>View</button></a>
                                        <a href='editmemprof.php?memberid={$rows['memberid']}'><button class='edit-btn'>Edit</button></a>
                                        <a href='deletememprof.php?memberid={$rows['memberid']}' onclick=\"return confirm('Are you sure?')\">
