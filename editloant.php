...
<body>
    ...
    <script>
        ...
        <div class="formcontainer">
            <form action="editloant.php?id=<?php echo $id ?>" method="post">
                <h1>Edit Loan Type</h1>
                <label for="loantypename">Loan Type Name:</label>
                <input type="text" id="loantypename" name="loantypename" value="<?php echo $profile['loantypename'] ?? '' ?>" required>

                <label for="description">Description:</label>
                <input type="text" id="description" name="description" value="<?php echo $profile['description'] ?? '' ?>" required>

                <div style="display: flex; justify-content: space-between;">
                    <button class="form-button cancel-button" type="button" onclick="window.location.href='loant.php'">Cancel</button>
