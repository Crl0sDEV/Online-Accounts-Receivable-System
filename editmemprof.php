...
<body>
    ...
    <script>
        ...
        <div class="formcontainer">
            <form action="editmemprof.php?memberid=<?php echo $id ?>" method="post">
                <h1>Edit Member Profile</h1>
                <label for="name">Name:</label>
                <input type="text" id="name" name="name" value="<?php echo $profile['fullname'] ?? '' ?>" required>

                <label for="address">Address:</label>
                <input type="text" id="address" name="address" value="<?php echo $profile['address'] ?? '' ?>" required>

                <label for="bday">Birthdate:</label>
                <input type="date" id="bday" name="bday" value="<?php echo $profile['birthdate'] ?? '' ?>" required>

                <label for="sex">Sex:</label>
                <select id="sex" name="sex" required>
                    <option value="Male" <?php if (($profile['sex'] ?? '') == 'Male') echo 'selected'; ?>>Male</option>
                    <option value="Female" <?php if (($profile['sex'] ?? '') == 'Female') echo 'selected'; ?>>Female</option>
                </select>
                ...
                <div style="display: flex; justify-content: space-between;">
                    <button class="form-button cancel-button" type="button" onclick="window.location.href='memberprofile.php'">Cancel</button>
