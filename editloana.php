...
if ($id) {
    $sql = "SELECT * FROM loanamortization WHERE id = $id";
...
if (isset($_POST['btnUpdate'])) {
    ...
    $sql = "UPDATE loanamortization SET 
        loantype = '$loantype',
        loanterm = '$loanterm',
        loanamor = '$loanamor'
        WHERE id = $id";
...
<body>
    ...
    <script>
        ...
        <div class="formcontainer">
            <form action="editloana.php?id=<?php echo $id ?>" method="post">
                <h1>Edit Loan Type</h1>
                <label for="loantype">Loan Type Name:</label>
                <input type="text" id="loantype" name="loantype" value="<?php echo $profile['loantype'] ?? '' ?>" required>

                <label for="loanterm">Loan Term:</label>
                <input type="number" id="loanterm" name="loanterm" value="<?php echo $profile['loanterm'] ?? '' ?>" required>

                <label for="loanamor">Loan Amortization:</label>
                <input type="number" id="loanamor" name="loanamor" value="<?php echo $profile['loanamor'] ?? '' ?>" required>

                <div style="display: flex; justify-content: space-between;">
                    <button class="form-button cancel-button" type="button" onclick="window.location.href='loana.php'">Cancel</button>
