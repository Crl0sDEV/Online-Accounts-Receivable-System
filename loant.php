    ...
    <script>
        ...
        <div class="container">
            <div class="content-box">
                <div class="title">
                    <h1>Loan Types</h1>
                    <a href="addloantype.php"><button class="add-loantype-btn">+ Add Loan Type</button></a>
                </div>
                    ...
                    <?php
                        if (mysqli_num_rows($Result) > 0) {
                            ...
                            while ($rows = mysqli_fetch_array($Result)) {
                                ...
                                echo "<td>
                                    <a href='viewloant.php?id={$rows['id']}'><button class='view-btn'>View</button></a>
                                    <a href='editloant.php?id={$rows['id']}'><button class='edit-btn'>Edit</button></a>
                                    <a href='deleteloant.php?id={$rows['id']}' onclick=\"return confirm('Are you sure?')\">
