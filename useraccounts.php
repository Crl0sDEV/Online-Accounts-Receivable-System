    ...
    <script>
        ...
        <div class="container">
            <div class="content-box">
                <div class="title">
                    <h1>User Accounts</h1>
                    <a href="adduseraccount.php"><button class="add-user-btn">+ Add New User Account</button></a>
                </div>
                    ...
                    <?php
                        if (mysqli_num_rows($Result) > 0) {
                            ...
                            while ($rows = mysqli_fetch_array($Result)) {
                                ...
                                echo "<td>
                                        <a href='viewuseracc.php?id={$rows['id']}'><button class='view-btn'>View</button></a>
                                        <a href='edituseracc.php?id={$rows['id']}'><button class='edit-btn'>Edit</button></a>
                                        <a href='deleteuseracc.php?id={$rows['id']}' onclick=\"return confirm('Are you sure?')\">
