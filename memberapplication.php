                    ...
                    <?php
                        if (mysqli_num_rows($Result) > 0) {
                            ...
                            while ($rows = mysqli_fetch_array($Result)) {
                                ...
                                echo "<td>
                                        <form action='approveloanapp.php' method='POST'>
                                            <input type='hidden' name='id' value='{$rows['id']}'>
                                            <button type='submit' name='approve' class='approve-btn'>Approve</button>
                                        </form>
                                        <a href='disapprovememprof.php?id={$rows['id']}' onclick=\"return confirm('Are you sure you want to reject?')\">
                                            <button class='delete-btn'>Disapproved</button>
                                      </td>";
                                echo "</tr>";
                                $id++;
                            }
