...
$conn = openCon();
$sql = "SELECT * FROM loanamortization"; 
        ...
        <div class="container">
            <div class="content-box">
                <div class="title">
                    ...
                    <a href="addloanamor.php"><button class="add-loanamor-btn">+ Add Loan Amortization</button></a>
                </div>
                    ...
                    <?php
                        if (mysqli_num_rows($Result) > 0) {
                            ...
                            while ($rows = mysqli_fetch_array($Result)) {
                                ...
                                echo "<td>{$rows['loanterm']}</td>";
                                echo "<td>{$rows['loanamor']}</td>";
                                echo "<td>
                                    <a href='viewloana.php?id={$rows['id']}'><button class='view-btn'>View</button></a>
                                    <a href='editloana.php?id={$rows['id']}'><button class='edit-btn'>Edit</button></a>
                                    <a href='deleteloana.php?id={$rows['id']}' onclick=\"return confirm('Are you sure?')\">
